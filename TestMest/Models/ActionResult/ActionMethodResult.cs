using TestMest.Models.Constants;

namespace TestMest.Models.ActionResult;
...
/// Результат запроса
/// </summary>
public class ActionMethodResult<T> where T : class
{
    /// <summary>
    /// Флаг результата
    /// </summary>
    ...
    protected ActionMethodResult(string code, T data) : this(code)
    {
        this.Data = data;
    }
    ...
    protected ActionMethodResult(string code, string title, string text, T data = null) : this(code, title, text)
    {
        this.Data = data;
    }
}
